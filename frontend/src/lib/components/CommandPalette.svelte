<script lang="ts">
	...
	const commands: PaletteCommand[] = [
		...
		{ label: "Create pull request", icon: "pr", action: () => quay.openNewPrModal() },
		{ label: "View pull requests", icon: "pr", action: () => quay.setActiveView("prs") },
		{ label: "New issue", icon: "issue", action: () => quay.openNewIssueModal() },
		...
		{ label: "Draft a release", icon: "tag", action: () => quay.openDraftReleaseModal() },
		{ label: "View releases", icon: "tag", action: () => quay.setActiveView("releases") },
		{ label: "View stashes", icon: "branch", action: () => quay.setActiveView("stashes") },
		{ label: "View tags", icon: "tag", action: () => quay.setActiveView("tags") },
		{ label: "View remotes", icon: "folder", action: () => quay.setActiveView("remotes") },
		{ label: "View history", icon: "clock", action: () => quay.setActiveView("history") },
